...
public class DetallePedido {
    ...
    public DetallePedido(int idPedido, int idProducto, int cantidad, double precioUnitario, int numeroLinea) {
        this.idPedido = idPedido;
        this.idProducto = idProducto;
        this.cantidad = cantidad;
        this.precioUnitario = precioUnitario;
    ...
    public String toString() {
        return "DetallePedido [idDetallePedido=" + idDetallePedido + ", idPedido=" + idPedido + ", idProducto="
                + idProducto + ", cantidad=" + cantidad + ", precioUnitario=" + precioUnitario + ", numeroLinea="
                + numeroLinea + "]";
    }
