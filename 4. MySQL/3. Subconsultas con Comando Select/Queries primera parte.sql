...
ADD COLUMN correo_electronico VARCHAR(100) AS (CONCAT(nombre, apellido, '@mail.com'));
...
-- modifiqué un registro que hice dos veces jiji:
UPDATE empleados SET nombre = 'Damián' WHERE id = 6;
...
SET SQL_SAFE_UPDATES = 0; -- desactiva safe mode
